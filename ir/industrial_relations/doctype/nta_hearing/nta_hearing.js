...
frappe.ui.form.on('NTA Hearing', {
    ...
    linked_disciplinary_action: function(frm) {
        if (frm.doc.linked_disciplinary_action) {
        	...
        	// Fetch accysed_coy field from Disciplinary Action document and enter into coy field
            frappe.db.get_value('Disciplinary Action', frm.doc.linked_disciplinary_action, 'accused_coy', (r) => {
            ...
            frappe.db.get_value('Disciplinary Action', frm.doc.linkd_disciplinary_action, 'company', (r) => {
